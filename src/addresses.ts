...
export const V2_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.UNILAYER_TESTNET]: '0xC018Fe11D1e4aa743646e22E87E051f901f4B349'
}
/**
...
export const V2_ROUTER_ADDRESSES: AddressMap = {
  ...
  [ChainId.UNILAYER_TESTNET]: '0x3b76F1e2a6c136e2d5e86DD737e32c2313002D5c'
}
...
const UNILAYER_TESTNET_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: '0x0000000000000000000000000000000000000000', // Not deployed yet
  multicallAddress: '0x0cf4A2d998B8616Fccd3a5a44a0fFA6f14f58e83',
  quoterAddress: '0x0000000000000000000000000000000000000000', // Not deployed yet
  v3MigratorAddress: '0x0000000000000000000000000000000000000000', // Not deployed yet
  nonfungiblePositionManagerAddress: '0x0000000000000000000000000000000000000000',
  tickLensAddress: '0x0000000000000000000000000000000000000000', // Not deployed yet
  swapRouter02Address: '0x0000000000000000000000000000000000000000' // Not deployed yet
}
...
export const CHAIN_TO_ADDRESSES_MAP: Record<SupportedChainsType, ChainAddresses> = {
  ...
  [ChainId.UNILAYER_TESTNET]: UNILAYER_TESTNET_ADDRESSES
}
...
export const ENS_REGISTRAR_ADDRESSES: AddressMap = {
  ...
  [ChainId.UNILAYER_TESTNET]: '0x20a84e97097BB344c29635150904938d986b08F3'
}
